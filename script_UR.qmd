...
#### Marc Vez-Garzón, Sandra Moreno, Guillem Casbas, Victor Colomar, Oriol Lapiedra
...
### 1.1. Load map and define sampling points
...
### 1.2. Calculate urbanization index
...
### 2.1. Data set cleaning and exploratory plots
...
### 2.2. One-way ANOVA + Tukey's HSD test on lizard abundance
...
### 3.3. Zero-inflated + Poisson part ANOVAs
...
### 5.1. Load data and exploratory plots
...
### 5.2. One-way ANOVA + Tukey's HSD test on snake captures
